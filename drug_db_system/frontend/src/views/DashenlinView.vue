  ...
  <div class="dashenlin-page">
    ...
    <div class="toolbar card desktop-only">
      <div class="actions">
        ...
        <el-button type="primary" :icon="TrendCharts" @click="dashboardVisible = true">数字看板</el-button>
    ...
    <DashboardPanel v-model="dashboardVisible" :db-key="dbKey" />
    ...
    <MobileNavBar
      ...
      @dashboard="dashboardVisible = true"
    ...
    <MobileFilterSheet
      ...
      product-label="商品编码"
      city-label="城市"
      product-placeholder="1058746,1086127"
      city-placeholder="广州,深圳"
...
import { Search, Upload, Download, RefreshRight, UploadFilled, InfoFilled, WarningFilled, DataLine, Setting, Delete, CircleCheck, CircleClose, TrendCharts } from '@element-plus/icons-vue'
...
async function handleExport() {
  ...
  try {
    ...
    // 裸 fetch 不走 client.ts，必须手动带令牌，否则会被后端 401 拦掉
    const tk = getToken()
